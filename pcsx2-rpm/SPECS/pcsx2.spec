%global commit e10ac8cbece9519165cf90e2698699cbf91b3f4f
%global short_commit e10ac8
...
install -pm 644 %{_builddir}/%{name}-%{commit}/linux_various/PCSX2.xpm %{buildroot}/%{_datadir}/icons/hicolor/128x128/apps/

# Install Desktop file
mv %{_builddir}/%{name}-%{commit}/linux_various/PCSX2.desktop.in %{_builddir}/%{name}-%{commit}/linux_various/PCSX2.desktop
desktop-file-install                                    \
--dir=%{buildroot}/%{_datadir}/applications              \
%{_builddir}/%{name}-%{commit}/linux_various/PCSX2.desktop
...
%changelog
* Fri Dec 29 2017 wyvie <irum@redhat.com> - 1.5-0.git.e10ac8
- Rebuilt from master branch on e10ac8 commit
